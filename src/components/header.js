...
export default (props) => {
  ...
  <div className={styles.header}>
    ...
    <div className={styles.headerLinks}>
      ...
      <Link to="/work" className={styles.headerLink} style={getActiveBorder('/work')}>
        Work
      </Link>
      <Link to="/about" className={styles.headerLink} style={getActiveBorder('/about')}>
        About
      </Link>
      <Link to="/contact" className={styles.headerLink} style={getActiveBorder('/contact')}>
        Contact
      </Link>
    </div>
  </div>
